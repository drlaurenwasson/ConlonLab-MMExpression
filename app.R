    ...
    mainPanel(
      conditionalPanel(
        ...
        checkboxGroupInput(inputId = "timepoint",
                         label = "Time Points", 
                         choices = c("E09.5", "E10.5", "E11.5", "E12.5", "E13.5", "E14.5", "E15.5", "E16.5"),
                         selected = c("E09.5", "E10.5", "E11.5", "E12.5", "E13.5", "E14.5", "E15.5", "E16.5"),
                         inline = FALSE,
                         width = NULL,
                         choiceNames = NULL,
                         choiceValues = NULL
        ),
        selectInput("normalize", "Select Time Point to Normalize to", choices = c("E09.5", "E10.5", "E11.5", "E12.5", "E13.5", "E14.5", "E15.5", "E16.5")),
      ...
      conditionalPanel(
        ...
        checkboxGroupInput(inputId = "rnatimepoint",
                           label = "Time Points", 
                           choices = c("E09.5", "E10.5", "E12.5", "E14.5", "E16.5"),
                           selected = c("E09.5", "E10.5", "E12.5", "E14.5", "E16.5"),
                           inline = FALSE,
                           width = NULL,
                           choiceNames = NULL,
                           choiceValues = NULL
        ),
        selectInput("normalize2", "Select Time Point to Normalize to", choices = c("E09.5", "E10.5", "E12.5", "E14.5", "E16.5")),
      ...
      conditionalPanel(
        ...
        selectInput("normalize3", "Select Time Point to Normalize to", choices = c("E09.5", "E10.5", "E12.5", "E14.5", "E16.5")),
